...
row = {
    "phone_id": 18,
    "canonical_name": "OPPO Reno9 Pro+",
    "model_id": "PHK110",

    "release_date_global": "2022-12-02",
    ...
    "dimensions_mm": "161.5 x 73.6 x 7.99",
    "weight_g": 192,

    "build_frame": "Plastic",
    "build_back": "Glass",
    "ip_rating": pd.NA,
    "colors_available": "Tomorrow Gold; Haoyue Black",
    ...
    "os_launch": "Android 13; ColorOS 13",
    "os_current": pd.NA,
...
# Remove existing Phone 18 if present
df = df[df["phone_id"] != 18]
...
print("Phone 18 added successfully.")
print(df[df["phone_id"] == 18].T)