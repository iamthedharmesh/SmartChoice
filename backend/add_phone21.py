...
row = {
    ...
    "dimensions_mm": "163.4 x 74.3 x 8.7",
    "weight_g": 204,

    "build_frame": "Plastic",
    "build_back": "Glass",
    "ip_rating": pd.NA,
    "colors_available": "Galactic Silver; Sonic Black",
    ...
    "os_current": pd.NA,
    "os_update_policy_years": "4 Android updates + 5 years security",

    "official_product_url": "https://www.oneplus.in/11r",
    "official_image_url": pd.NA,
    "local_image_path": pd.NA,
    "gsmarena_url": pd.NA,

    "launch_price_inr_official": 39999,
...
print("Phone 21 added successfully.")
print(df[df["phone_id"] == 21].T)