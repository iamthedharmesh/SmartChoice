...
phone4 = {
    "phone_id": 4,
    "canonical_name": "Motorola Moto G62 5G",
    "model_id": "XT2223-3",

    "release_date_global": "2022-06-09",
    "release_date_india": "2022-08-11",
    ...
    "dimensions_mm": "161.83 x 73.96 x 8.59",
    "weight_g": 184,
    "build_frame": "Plastic",
    "build_back": "Plastic",
    "ip_rating": "IP52",
    "colors_available": "Midnight Gray, Frosted Blue",

    "sim_type": "Dual Nano SIM, Hybrid Slot",
    ...
    "os_current": "Android 13",
    "os_update_policy_years": "1 Android OS Upgrade & 3 Years of Security Updates",

    "official_product_url": "https://www.motorola.in/smartphones-moto-g-62-5g/p",
    "official_image_url": pd.NA,
    "local_image_path": pd.NA,
    "gsmarena_url": "https://www.gsmarena.com/motorola_moto_g62_5g-11631.php",

    "launch_price_inr_official": 17999,
...
# Remove existing Phone 4 row if this script is run again.
df = df[df["phone_id"] != 4].copy()

new_row = pd.DataFrame([phone4])
new_row = new_row[df.columns]

df = pd.concat([df, new_row], ignore_index=True)
df.to_csv(DATA_PATH, index=False)

print("Phone 4 written successfully.")
print(f"Rows: {len(df)}")
print(f"Columns: {len(df.columns)}")

row = df[df["phone_id"] == 4].iloc[0]

print("\nPhone 4 verification:")
