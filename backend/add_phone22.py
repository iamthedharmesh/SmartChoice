...
row = {
    "phone_id": 22,
    "canonical_name": "vivo V25 Pro 5G",
    "model_id": "V2158",

    "release_date_global": "2022-08-17",
    "release_date_india": "2022-08-17",
    "availability_status_india": "Released",
    "discontinued_date_india": pd.NA,

    "display_size_inch": 6.56,
    "display_type": "AMOLED",
    "display_resolution": "2376x1080",
    "display_refresh_rate_hz": 120,
    "display_protection": "Schott Xensation Up",
    ...
    "dimensions_mm": "158.9 x 73.52 x 8.62",
    "weight_g": 190,

    "build_frame": "Plastic",
    "build_back": "Glass",
    "ip_rating": pd.NA,
    "colors_available": "Surfing Blue; Diamond Black",

    "sim_type": "Dual Nano-SIM",
    "five_g_bands": "n1,n3,n5,n7,n8,n28,n38,n40,n41,n77,n78",
    ...
    "official_product_url": "https://www.vivo.com/in/products/v25-pro",
...
print("Phone 22 added successfully.")
print(df[df["phone_id"] == 22].T)