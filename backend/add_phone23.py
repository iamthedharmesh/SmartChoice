...
row = {
    "phone_id": 23,
    "canonical_name": "POCO X4 Pro 5G",
    "model_id": "2201116PI",

    "release_date_global": "2022-02-28",
    "release_date_india": "2022-03-23",
    ...
    "dimensions_mm": "164.19 x 76.1 x 8.12",
    "weight_g": 205,

    "build_frame": "Plastic",
    "build_back": "Glass",
    "ip_rating": "IP53",
    "colors_available": "Laser Black; Laser Blue; Poco Yellow",
    ...
    "os_launch": "Android 11; MIUI 13 for POCO",
    "os_current": pd.NA,
...
print("Phone 23 added successfully.")
print(df[df["phone_id"] == 23].T)