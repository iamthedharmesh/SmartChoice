...
row = {
    "phone_id": 20,
    "canonical_name": "vivo Y22",
    "model_id": "V2207",

    "release_date_global": "2022-09-05",
    "release_date_india": "2022-09-12",
    "availability_status_india": "Released",
    "discontinued_date_india": pd.NA,

    "display_size_inch": 6.55,
    "display_type": "IPS LCD",
    "display_resolution": "1612x720",
    "display_refresh_rate_hz": 60,
    "display_protection": "Panda MN228",
    ...
    "dimensions_mm": "164.30 x 76.10 x 8.38",
    "weight_g": 192,

    "build_frame": "Plastic",
    "build_back": "Plastic",
    "ip_rating": "IPX4",
    "colors_available": "Starlite Blue; Metaverse Green; Summer Cyan",
    ...
    "official_product_url": "https://www.vivo.com/in/products/y22",
    "official_image_url": pd.NA,
    "local_image_path": pd.NA,
    "gsmarena_url": pd.NA,

    "launch_price_inr_official": 14499,
...
print("Phone 20 added successfully.")
print(df[df["phone_id"] == 20].T)