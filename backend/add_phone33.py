...
row = {
    "phone_id": 33,
    "canonical_name": "vivo V27 5G (8GB RAM + 256GB)",
    "model_id": "V2246",

    "release_date_global": "2023-02-01",
    "release_date_india": "2023-03-01",
    ...
    "dimensions_mm": "164.1 x 74.8 x 7.4",
    "weight_g": 180,

    "build_frame": "Plastic",
    "build_back": "Glass",
    "ip_rating": pd.NA,
    "colors_available": "Noble Black; Magic Blue",
...
print("Phone 33 added successfully.")
print(df[df["phone_id"] == 33].T)