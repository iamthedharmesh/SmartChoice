...
row = {
    ...
    "dimensions_mm": "159.2 x 74.2 x 7.79",
    "weight_g": 186,

    "build_frame": "Plastic",
    "build_back": "Glass",
    "ip_rating": pd.NA,
    "colors_available": "Aquamarine Blue; Sunrise Gold; Diamond Black",
    ...
    "official_product_url": "https://www.vivo.com/in/products/v25",
    "official_image_url": pd.NA,
    "local_image_path": pd.NA,
    "gsmarena_url": pd.NA,

    "launch_price_inr_official": 27999,
...
print("Phone 29 added successfully.")
print(df[df["phone_id"] == 29].T)