...
# NOTE:
# "OnePlus 11 Pro" does not correspond to an officially released
# OnePlus model. The released flagship is OnePlus 11.
# Therefore we do NOT invent specifications for this dataset entry.

row = {
    "phone_id": 30,
    "canonical_name": "OnePlus 11 Pro",
    "model_id": pd.NA,

    "release_date_global": pd.NA,
    "release_date_india": pd.NA,
    "availability_status_india": "Unverified dataset entry",
...
print("Phone 30 added successfully.")
print(df[df["phone_id"] == 30].T)